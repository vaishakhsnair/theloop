...
def api():
    ...
    with open(flname,'rb') as f:
        ...
        try:
            ...
            print('error')
            content = {"voltage":[request.form['field1']],"percent":[request.form['field2']],"RawVolt":request.form['field3']}
        ...
        print(request.form['field1'],request.form['field2'],request.form['field3'])
